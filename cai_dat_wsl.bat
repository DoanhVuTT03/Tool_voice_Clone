...
if errorlevel 1 (
    ...
    echo.
    echo Neu UAC bi tu choi / khong cai duoc:
    echo   Mo PowerShell (Run as administrator) va go:  wsl --install
...
echo.
echo === XONG! Engine WSL san sang. Mo app va chon "OmniVoice ... (WSL)". ===
echo.
pause
